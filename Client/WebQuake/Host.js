...
Host._Frame = function () {
    ...
    if (Host.speeds.value !== 0) {
        ...
        Con.Print(`${totalTime.toString().padStart(3, ' ')} tot ${Math.floor(serverTime).toString().padStart(3, ' ')} server ${Math.floor(graphicsTime).toString().padStart(3, ' ')} gfx ${Math.floor(soundTime).toString().padStart(3, ' ')} snd\n`);
    }
